...
export default function Modal({ isOpen, onClose, title = "Записатися до школи", source = "Сайт" }) {
    ...
    try {
      ...
      const response = await fetch('/api/telegram', {
        ...
        body: JSON.stringify({
          ...
          source: source, // Передаем источник заявки
        }),
      });
      ...
      <div className={styles.modalWrapper}>
        ...
        {submitStatus === 'success' ? (
          ...
          <div className={styles.error}>
            ...
            <p>Виникла помилка при відправці.</p>
            <p>Спробуйте ще раз або зателефонуйте нам.</p>
          </div>
        ) : (
