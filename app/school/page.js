      ...
      <main className={styles.main}>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.heroContent}>
              ...
              <p className={styles.subtitle}>
                Школа повного дня <br />
                Де найголовніше, це виховання та розвиток вашої дитини
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.container}>
            <div className={styles.aboutContent}>
              <div className={styles.aboutText}>
                ...
                <p>
                  Ми поєднуємо НУШ з сучасними освітніми практиками, щоб дати дітям не лише знання, а й внутрішню опору.
                </p>
              </div>
        ...
        <section className={`${styles.approachSection} ${styles.fadeIn}`} ref={el => sectionsRef.current[1] = el}>
          <div className={styles.container}>
            ...
            <div className={styles.philosophyText}>
              <p>
                Ми знаходимо підхід до кожної дитини, враховуючи її індивідуальні особливості та допомагаючи розкрити потенціал. Приділяємо увагу всебічному розвитку - інтелектуальному, емоційному та соціальному.
              </p>
              <p>
                Свідомо обмежуємо використання гаджетів під час навчання, щоб зберегти увагу дітей, розвивати живе спілкування та формувати здорові звички.
              </p>
              <p>
                Класи до 15 діточок, школа повного дня з 8:30-18:00
              </p>
              <p>
                Обов'язкові прогулянки та творчі заняття
              </p>
              <p>
                У нас уроки починаються о 9:30
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={`${styles.programSection} ${styles.fadeIn}`} ref={el => sectionsRef.current[3] = el}>
          <div className={styles.container}>
            ...
            <div className={styles.philosophyText}>
              <p>
                Ми працюємо за програмою ОДМ, яка поєднує сучасні освітні підходи з перевіреними методиками навчання. Вона спрямована не лише на засвоєння знань, а й на розвиток логічного мислення, уваги, самостійності та вміння застосовувати знання на практиці.
              </p>
              <p>
                Навчальний процес побудований таким чином, щоб діти глибоко розуміли матеріал, вміли аналізувати, ставити запитання та знаходити рішення. Ми приділяємо увагу як академічним результатам, так і розвитку особистості кожного учня.
              </p>
              <p>
